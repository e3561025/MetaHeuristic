...
public class AntColonyOptimizationOfTSA {
    ...
    public double init(){
        ...
        for(int iter=0;iter<this.iterator;iter++){
            ...
            Collections.sort(ants, new Comparator<AntAndRunningCity>(){
                public int compare(AntAndRunningCity a1,AntAndRunningCity a2){
                    if(a1.ant.totalPath<a2.ant.totalPath){
                        return 1;
                    }else{
                        return 0;
                    }
            ...
            //decrease pheromone
            antCity.pheromoneVolatilize(decrease);
